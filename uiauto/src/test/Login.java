...
//		driver.findElementByXPath("//android.widget.EditText[@text='请填写手机号码']").sendKeys("13714672776");
//		driver.findElementByXPath("//android.widget.EditText[@text='请填写验证码']").sendKeys("1234");
